 ...
 */
/* CircuitInterface_dcd86948_1_ds.c - body for module CircuitInterface_dcd86948_1_ds */

#include "ne_ds.h"
#include "CircuitInterface_dcd86948_1_ds_obs_il.h"
#include "CircuitInterface_dcd86948_1_ds_obs_all.h"
#include "CircuitInterface_dcd86948_1_ds_obs_act.h"
#include "CircuitInterface_dcd86948_1_ds_obs_exp.h"
...
static NeEquationData s_equation_data[3] = { { "", 0U, 8,
    NE_EQUATION_DOMAIN_TIME, "CircuitInterface/Model/C", 1U, 0U, TRUE, 1.0, "1",
  }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME, "CircuitInterface/Model/R1", 1U, 1U,
    TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "CircuitInterface/Model/SPST Switch", 3U, 2U, TRUE, 1.0, "1", } };

static NeCERData *s_cer_data = NULL;
static NeICRData *s_icr_data = NULL;
static NeVariableData s_variable_data[3] = { { "Model.C.vc", 0U, 0,
    "CircuitInterface/Model/C", 1.0, "1", 0.0, TRUE, FALSE, { { 1, 1 } },
    NE_INIT_MODE_MANDATORY, "Capacitor voltage", }, { "Model.C.i", 0U, 0,
    "CircuitInterface/Model/C", 1.0, "1", 0.0, FALSE, FALSE, { { 1, 1 } },
    NE_INIT_MODE_NONE, "Current", }, { "Model.SPST_Switch.v", 0U, 0,
    "CircuitInterface/Model/SPST Switch", 1.0, "1", 0.0, FALSE, FALSE, { { 1, 1
      } }, NE_INIT_MODE_NONE, "Voltage", } };

static NeVariableData *s_discrete_data = NULL;
static NeObservableData s_observable_data[45] = { { "Model.C.i",
    "CircuitInterface/Model/C", { { 1, 1 } }, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, { "Model.C.n.v",
    "CircuitInterface/Model/C", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "Model.C.p.v",
    "CircuitInterface/Model/C", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "Model.C.v",
    "CircuitInterface/Model/C", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "Model.C.vc",
    "CircuitInterface/Model/C", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_MANDATORY, FALSE, TRUE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Capacitor voltage", }, {
    "Model.C.power_dissipated", "CircuitInterface/Model/C", { { 1, 1 } }, "kW",
    1.0, "kW", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "Dissipated power", }, {
    "Model.Current_Sensor.I", "CircuitInterface/Model/Current Sensor", { { 1, 1
      } }, "A", 1.0, "A", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I", }, {
    "Model.Current_Sensor.i1", "CircuitInterface/Model/Current Sensor", { { 1, 1
      } }, "A", 1.0, "A", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, {
    "Model.Current_Sensor.n.v", "CircuitInterface/Model/Current Sensor", { { 1,
        1 } }, "V", 1.0, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Model.Current_Sensor.p.v", "CircuitInterface/Model/Current Sensor", { { 1,
        1 } }, "V", 1.0, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Model.Current_Sensor_I0", "CircuitInterface/Model/PS-Simulink\nConverter2",
    { { 1, 1 } }, "A", 1.0, "A", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Current_Sensor_I0", }, {
    "Model.Electrical_Reference.V.v",
    "CircuitInterface/Model/Electrical Reference", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Model.Electrical_Reference1.V.v",
    "CircuitInterface/Model/Electrical Reference1", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Model.Electrical_Reference2.V.v",
    "CircuitInterface/Model/Electrical Reference2", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Model.Electrical_Reference3.V.v",
    "CircuitInterface/Model/Electrical Reference3", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Model.Electrical_Reference4.V.v",
    "CircuitInterface/Model/Electrical Reference4", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "Model.R1.i",
    "CircuitInterface/Model/R1", { { 1, 1 } }, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, { "Model.R1.n.v",
    "CircuitInterface/Model/R1", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "Model.R1.p.v",
    "CircuitInterface/Model/R1", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "Model.R1.v",
    "CircuitInterface/Model/R1", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Model.R1.power_dissipated", "CircuitInterface/Model/R1", { { 1, 1 } },
    ...
    "Model.R2.i", "CircuitInterface/Model/R2", { { 1, 1 } }, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, { "Model.R2.n.v",
    "CircuitInterface/Model/R2", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "Model.R2.p.v",
    "CircuitInterface/Model/R2", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "Model.R2.v",
    "CircuitInterface/Model/R2", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Model.R2.power_dissipated", "CircuitInterface/Model/R2", { { 1, 1 } },
    "A^2*Ohm", 1.0, "A^2*Ohm", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "Dissipated power", }, {
    "Model.SPST_Switch.i", "CircuitInterface/Model/SPST Switch", { { 1, 1 } },
    "A", 1.0, "A", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, { "Model.SPST_Switch.n.v",
    "CircuitInterface/Model/SPST Switch", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "Model.SPST_Switch.p.v",
    "CircuitInterface/Model/SPST Switch", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Model.SPST_Switch.power_dissipated", "CircuitInterface/Model/SPST Switch",
      { { 1, 1 } }, "W", 1.0, "kW", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Power dissipated", }, {
    "Model.SPST_Switch.v", "CircuitInterface/Model/SPST Switch", { { 1, 1 } },
    "V", 1.0, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "Model.SPST_Switch.vT",
    "CircuitInterface/Model/SPST Switch", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "vT", }, {
    "Model.Simulink_PS_Converter_output0",
    "CircuitInterface/Model/Simulink-PS\nConverter", { { 1, 1 } }, "1", 1.0, "1",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Simulink_PS_Converter_output0", }, {
    "Model.Voltage_Sensor.V", "CircuitInterface/Model/Voltage Sensor", { { 1, 1
      } }, "V", 1.0, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "V", }, {
    "Model.Voltage_Sensor.n.v", "CircuitInterface/Model/Voltage Sensor", { { 1,
        1 } }, "V", 1.0, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Model.Voltage_Sensor.p.v", "CircuitInterface/Model/Voltage Sensor", { { 1,
        1 } }, "V", 1.0, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Model.Voltage_Sensor1.V", "CircuitInterface/Model/Voltage Sensor1", { { 1,
        1 } }, "V", 1.0, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "V", }, {
    "Model.Voltage_Sensor1.n.v", "CircuitInterface/Model/Voltage Sensor1", { { 1,
        1 } }, "V", 1.0, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Model.Voltage_Sensor1.p.v", "CircuitInterface/Model/Voltage Sensor1", { { 1,
        1 } }, "V", 1.0, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Model.Voltage_Sensor1_V0", "CircuitInterface/Model/PS-Simulink\nConverter1",
    { { 1, 1 } }, "V", 1.0, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Voltage_Sensor1_V0", }, {
    "Model.Voltage_Sensor_V0", "CircuitInterface/Model/PS-Simulink\nConverter",
      { { 1, 1 } }, "V", 1.0, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Voltage_Sensor_V0", }, {
    "Model.Vs.i", "CircuitInterface/Model/Vs", { { 1, 1 } }, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current (positive in)", }, {
    "Model.Vs.n.v", "CircuitInterface/Model/Vs", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "Model.Vs.p.v",
    "CircuitInterface/Model/Vs", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "Model.Vs.v",
    "CircuitInterface/Model/Vs", { { 1, 1 } }, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", } };

static NeModeData *s_major_mode_data = NULL;
static NeZCData s_zc_data[1] = { { "CircuitInterface/Model/SPST Switch", 1U, 0U,
    "Model.SPST_Switch",
    "C:/Program Files/MATLAB/R2023b/toolbox/physmod/elec/library/m/+ee/+switches/spst_ps.sscp",
    NE_ZC_TYPE_FALSE, } };
...
static NeAssertData s_assert_data[8] = { { "CircuitInterface/Model/C", 1U, 0U,
    "Model.C.power_dissipated",
    ...
    "CircuitInterface/Model/C", 1U, 1U, "Model.C.power_dissipated",
    "C:/Program Files/MATLAB/R2023b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/capacitor.ssc",
    FALSE,
    ...
    "CircuitInterface/Model/C", 1U, 2U, "Model.C.power_dissipated",
    "C:/Program Files/MATLAB/R2023b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/capacitor.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "CircuitInterface/Model/C", 1U, 3U, "Model.C.power_dissipated",
    "C:/Program Files/MATLAB/R2023b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/capacitor.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "CircuitInterface/Model/R1", 1U, 4U, "Model.R1.power_dissipated",
    "C:/Program Files/MATLAB/R2023b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/resistor.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "CircuitInterface/Model/R1", 1U, 5U, "Model.R1.power_dissipated",
    "C:/Program Files/MATLAB/R2023b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/resistor.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "CircuitInterface/Model/R2", 1U, 6U, "Model.R2.power_dissipated",
    "C:/Program Files/MATLAB/R2023b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/resistor.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "CircuitInterface/Model/R2", 1U, 7U, "Model.R2.power_dissipated",
    "C:/Program Files/MATLAB/R2023b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/resistor.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", } };
...
static NeParameterData s_real_parameter_data[1] = { { "RTP_8A769BFB_v",
    "CircuitInterface/Model/C", "", 0U, 1U, TRUE, } };
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mDXF.mN = 3;
  out->mDXF.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 3);
  return out;
}
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mLOG.mN = 30;
  out->mLOG.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 30);
  return out;
}
...
NeDynamicSystem *CircuitInterface_dcd86948_1_dae_ds(PmAllocator *allocator)
{
  NeDynamicSystem *ds;
  _NeDynamicSystem *_ds;
  ...
  input_info[0].mIdentifier = "Model.Simulink_PS_Converter_output0";
  ...
  input_info[0].mName = "Model.Simulink_PS_Converter_output0";
  input_info[0].mUnit = "1";
  ds->mIo[SSC_INPUT_IO_TYPE] = input_info;
  ds->mNumIo[SSC_OUTPUT_IO_TYPE] = 3;
  output_info[0].mIdentifier = "Model.Current_Sensor_I0";
  ...
  output_info[0].mName = "Model.Current_Sensor_I0";
  output_info[0].mUnit = "A";
  output_info[1].mIdentifier = "Model.Voltage_Sensor1_V0";
  ...
  output_info[1].mName = "Model.Voltage_Sensor1_V0";
  output_info[1].mUnit = "V";
  output_info[2].mIdentifier = "Model.Voltage_Sensor_V0";
  ...
  output_info[2].mName = "Model.Voltage_Sensor_V0";
  ...
  ds->mMethods[NE_DS_METHOD_LOG] = CircuitInterface_dcd86948_1_ds_log;
  ...
  ds->mMethods[NE_DS_METHOD_OBS_EXP] = CircuitInterface_dcd86948_1_ds_obs_exp;
  ds->mMakeOutput[NE_DS_METHOD_OBS_EXP] = ds_output_obs_exp;
  ds->mMethods[NE_DS_METHOD_OBS_ACT] = CircuitInterface_dcd86948_1_ds_obs_act;
  ds->mMakeOutput[NE_DS_METHOD_OBS_ACT] = ds_output_obs_act;
  ds->mMethods[NE_DS_METHOD_OBS_ALL] = CircuitInterface_dcd86948_1_ds_obs_all;
  ds->mMakeOutput[NE_DS_METHOD_OBS_ALL] = ds_output_obs_all;
  ds->mMethods[NE_DS_METHOD_OBS_IL] = CircuitInterface_dcd86948_1_ds_obs_il;
...
static int32_T ds_f (const NeDynamicSystem *sys, const NeDynamicSystemInput *t3,
                     NeDsMethodOutput *t4)
{
  PmRealVector out;
  real_T X_idx_0;
  ...
  X_idx_2 = t3->mX.mX[2];
  out = t4->mF;
  X_idx_0 = X_idx_0 * 0.001 + X_idx_1 * 1.000000001;
  if (M_idx_0 != 0) {
    X_idx_0 = X_idx_2 - X_idx_0 * 0.01;
  } else {
    X_idx_0 -= X_idx_2 * 1.0E-6;
  }
...
static int32_T ds_a (const NeDynamicSystem *sys, const NeDynamicSystemInput *t12,
                     ...
                     NeDsMethodOutput *t4)
{
  ...
  X_idx_2 = t3->mX.mX[2];
  out = t4->mY;
  out.mX[0] = X_idx_0 * 0.001 + X_idx_1 * 1.000000001;
  out.mX[1] = -X_idx_2 + 5.0;
  out.mX[2] = X_idx_1 * 1.0E-6 + X_idx_0;
  (void)sys;
  (void)t4;
  return 0;
}
